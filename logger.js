...
const infoStream = createWriteStream("Logger/info.log", { flags: "a" });
const errorStream = createWriteStream("Logger/error.log", { flags: "a" });
const debugStream = createWriteStream("Logger/debug.log", { flags: "a" });
const criticalStream = createWriteStream("Logger/critical.log", {
  flags: "a",
});
